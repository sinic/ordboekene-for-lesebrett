...
<img title="KOReader" src="screenshots/KOReader.png" width="35%" alt="Screenshot of dictionary on KOReader"> <img title="Kobo" src="screenshots/Kobo.png" width="35%" alt="Screenshot of dictionary on stock Kobo">
